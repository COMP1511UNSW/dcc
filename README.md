...
* Installation on Linux and Windows Subsystem for Linux
	...
	```bash
	curl -L https://github.com/COMP1511UNSW/dcc/releases/download/2.6.7/dcc_2.6.7_all.deb -o /tmp/dcc_2.6.7_all.deb
	sudo apt install /tmp/dcc_2.6.7_all.deb
...
* Installation on  OSX
    ...
    ```bash
	sudo curl -L https://github.com/COMP1511UNSW/dcc/releases/download/2.6.7/dcc -o /usr/local/bin/dcc
