...
* Installation on Linux and Windows Subsystem for Linux
	...
	```bash
	curl -L https://github.com/COMP1511UNSW/dcc/releases/download/2.7.1/dcc_2.7.1_all.deb -o /tmp/dcc_2.7.1_all.deb
	sudo apt install /tmp/dcc_2.7.1_all.deb
...
* Installation on  OSX
    ...
    ```bash
	sudo curl -L https://github.com/COMP1511UNSW/dcc/releases/download/2.7.1/dcc -o /usr/local/bin/dcc
