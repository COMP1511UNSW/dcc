...
* Deb-based Systems including Debian, Ubuntu, Mint and Windows Subsystem for Linux
	...
	```bash
	curl -L https://github.com/COMP1511UNSW/dcc/releases/download/2.20/dcc_2.20_all.deb -o /tmp/dcc_2.20_all.deb
	sudo apt install /tmp/dcc_2.20_all.deb
	```
	...
	sudo curl -L https://github.com/COMP1511UNSW/dcc/releases/download/2.20/dcc -o /usr/local/bin/dcc
